...
// --- Swipeable Helper Component (Mutual Exclusion Supported) ---
const SwipeableDelete = ({ children, onDelete, isOpen, onOpenStateChange }: { children: React.ReactNode; onDelete: () => void, isOpen: boolean, onOpenStateChange: (open: boolean) => void }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-card bg-bg-base">
